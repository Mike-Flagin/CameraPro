package toolsapps.com.camerapro;
...
public class Camera2BasicFragment extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
     ...
     */
    private static final int MAX_PREVIEW_HEIGHT = 4000;
     ...
     * respective max size, and whose aspect ratio matches with the specified valasue. If such size
